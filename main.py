...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str, required=False, default="./configs/MetaFG_meta_1_224.yaml", metavar="FILE", help='path to config file', )
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--data-path',default="/home/gtj/papercode/data/", type=str, help='path to dataset')
    ...
    parser.add_argument('--tag', default="cub-200_v1", help='tag of experiment')
    ...
    parser.add_argument('--pretrain', type=str, default="/home/gtj/papercode/data/MetaFormer_model/metafg_0_1k_224.pth",
                        help='pretrain')
    ...
    parser.add_argument("--local_rank", type=int, required=False, default=-1, help='local rank for DistributedDataParallel')
